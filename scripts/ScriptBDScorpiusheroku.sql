...
-- -----------------------------------------------------
-- Schema heroku_b2bb69a6ece6032
-- ----------------------------------------------------

-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`exposicao`
-- era bom saber se uma atividade diferenciada pode ocorrer em apenas 1 turno
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`exposicao` (
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`cidade_UF`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`cidade_UF` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`instituicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`instituicao` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_instituicao_cidade_UF`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`cidade_UF` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`tipo_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`tipo_usuario` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`usuario` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  ...
  CONSTRAINT `fk_usuario_tipo_usuario`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`tipo_usuario` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`email_verificacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`email_verificacao` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_email_verficacao_usuario1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`usuario` (`email`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
  )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`professor_instituicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`professor_instituicao` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_professor_instituicao_instituicao1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`instituicao` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_professor_instituicao_usuario1`
    FOREIGN KEY (`usuario_ID`)
    REFERENCES `heroku_b2bb69a6ece6032`.`usuario` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`turma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`turma` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`visita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`visita` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`agendamento_institucional`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`agendamento_institucional` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_agendamento_institucional_turma1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`turma` (`ID`)
    ON DELETE SET NULL
    ON UPDATE SET NULL,
  ...
  CONSTRAINT `fk_agendamento_institucional_professor_instituicao_ID1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`professor_instituicao` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  INDEX `fk_Visita_idx` (`visita`),
  CONSTRAINT `fk_agendamento_institucional_visita1`
    FOREIGN KEY (`visita`)
    REFERENCES `heroku_b2bb69a6ece6032`.`visita` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

ALTER TABLE `heroku_b2bb69a6ece6032`.`visita` 
ADD CONSTRAINT `fk_visita_agendamento_institucional_ID1`
    FOREIGN KEY (`agendamento_institucional_ID`)
    REFERENCES `heroku_b2bb69a6ece6032`.`agendamento_institucional` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;

-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`agendamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`agendamento` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `visita` INT UNSIGNED NOT NULL,
  `data_agendamento` DATETIME NOT NULL,
  `observacao` VARCHAR(100) DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`permissao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`permissao` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`permissao_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`permissao_tipo` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_permissao1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`permissao` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
    )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`exposicao_agendamento_institucional`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`exposicao_agendamento_institucional` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_exposicao_agendamento_institucional_exposicao1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`exposicao` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`exposicao_agendamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`exposicao_agendamento` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `exposicao_ID` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_exposicao_agendamento_agendamento1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`agendamento` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`aluno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`aluno` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `idade` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`responsavel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`responsavel` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`visitante_institucional`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`visitante_institucional` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `status_Checkin` ENUM('compareceu', 'não compareceu') NOT NULL,
  `idade` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`visitante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`visitante` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `status_Checkin` ENUM('compareceu', 'não compareceu') NOT NULL,
  `idade` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`estagiario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`estagiario` (
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`horario_estagiario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`horario_estagiario` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_horario_estagiario_estagiario1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`estagiario` (`usuario_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`proposta_horario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`proposta_horario` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `dia_semana` VARCHAR(45) NOT NULL,
  `turno` VARCHAR(45) NOT NULL,
  `estagiario_usuario_ID` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`Acoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`Acoes` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `atividade` TINYTEXT(200) NOT NULL,
  PRIMARY KEY (`ID`),
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`log` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_log_acoes1`
    ...
    REFERENCES `heroku_b2bb69a6ece6032`.`acoes` (`ID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
...
-- -----------------------------------------------------
-- Table `heroku_b2bb69a6ece6032`.`Notificacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_b2bb69a6ece6032`.`notificacao` (
  `ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
