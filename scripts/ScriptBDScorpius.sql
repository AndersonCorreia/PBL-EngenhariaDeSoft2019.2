...
CREATE TABLE IF NOT EXISTS `mydb`.`professor_instituicao` (
  ...
  INDEX `fk_professor_instituicao_usuario1_idx` (`usuario_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`turma` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_turma_professor_instituicao1_idx` (`professor_instituicao_ID` ASC) VISIBLE,
  CONSTRAINT `fk_turma_professor_instituicao1`
    FOREIGN KEY (`professor_instituicao_ID`)
    REFERENCES `mydb`.`professor_instituicao` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`agendamento` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_agendamento_turma1_idx` (`turma_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`visita` (
  ...
  INDEX `fk_visita_usuario1_idx` (`ID_acompanhante` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`horario_estagiario` (
  ...
  INDEX `fk_horario_estagiario_estagiario1_idx` (`estagiario_usuario_ID` ASC) VISIBLE,
  CONSTRAINT `fk_horario_estagiario_estagiario1`
    FOREIGN KEY (`estagiario_usuario_ID`)
    REFERENCES `mydb`.`estagiario` (`usuario_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`proposta_horario` (
  ...
  `estagiario_usuario_ID` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`dia_semana`, `turno`, `estagiario_usuario_ID`),
  INDEX `fk_proposta_horario_estagiario1_idx` (`estagiario_usuario_ID` ASC) VISIBLE,
