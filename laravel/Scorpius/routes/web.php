...
Route::get('/demandaWeb', 'horarioEstagiarioController@index')->name("estagiario.show");
Route::post('/demandaWeb/enviar-horario', 'horarioEstagiarioController@cadastrarHorario')->name("estagiario.enviarHorario");