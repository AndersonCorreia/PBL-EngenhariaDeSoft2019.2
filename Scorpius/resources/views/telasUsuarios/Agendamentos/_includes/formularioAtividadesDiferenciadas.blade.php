...
<div class="modal fade" id ="modal-atividade-diferenciada{{$atividade['ID']}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form id="form.agendamento" class="container-fluid m-0 p-3" method="POST" action="{{route('AgendarAtividade.post')}}">
                {{csrf_field()}}
                <input type="hidden" name="exposicao" value={{$atividade['ID']}} >
